...
My way to following this, is to go through the [Linear Courses](#linear-courses) and then fortify the foundataions more by following [Specialised Courses](#specialised-courses).
...
## Specialised Courses
You may follow the order from [datanerd.tech](https://datanerd.tech/), in accordings to your country if you may.
